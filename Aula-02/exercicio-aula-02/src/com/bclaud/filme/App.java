...
public class App {
    public static void main(String[] args) {
        Diretor miyazaki = new Diretor("Hayao Miyazaki", "1941-01-05", 12, Genero.MASCULINO);
        Diretor spielberg = new Diretor("Steven Spielberg", "1946-12-18", 32, Genero.MASCULINO);
